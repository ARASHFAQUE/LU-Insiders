        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: (){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => ChatPage(currentUser: widget.currentUser,)));
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance.collection('chat-rooms').doc(
                          widget.chatroom.chatRoomId).collection('messages')
